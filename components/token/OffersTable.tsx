...
export const OffersTable: FC<Props> = ({ token, address, is1155, isOwner }) => {
  ...
  let userBidsQuery: Parameters<typeof useBids>['0'] = {
    maker: address,
    token: token,
    includeCriteriaMetadata: true,
    includeRawData: true,
  ...
  if (chain.community) {
    ...
    userBidsQuery.community = chain.community
  }
  ...
  const { data: userOffers } = useBids(userBidsQuery)
...
const OfferTableRow: FC<OfferTableRowProps> = ({
  ...
  const expirationText = `Expires ${expiration}`
  ...
  return (
    ...
    >
      <Flex direction="column" align="start" css={{ height: '100%' }}>
      ...
      <Flex direction="column" align="end" css={{ gap: '$2' }}>
        <Flex align="center" css={{ gap: '$2' }}>
          ...
          {/* Not Owner and is your offer, or owner of 1155 and is your offer */}
